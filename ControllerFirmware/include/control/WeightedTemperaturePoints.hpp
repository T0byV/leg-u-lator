...
class WeightedTemperaturePoints {
    public:
        WeightedTemperaturePoints(std::array<std::array<Sensor, SensM>, SensN> *sensors, const std::array<std::array<float, WeightM>, WeightN>& weight_matrix) : sensors{sensors}, weight_matrix{weight_matrix} {}
    ...
    private:
        std::array<std::array<Sensor, SensM>, SensN> *sensors;
